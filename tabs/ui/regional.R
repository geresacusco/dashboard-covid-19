regional <- tabPanel(title = "Nivel Regional", 
                ...
                HTML("El Análisis de la Pandemia por COVID-19 muestra, de forma clara y directa,
                   ...
                   fluidRow(
                   box(width = 12, 
                   valueBox(h2(strong("21,080")), "Casos totales 2021", icon = icon("virus", "fa-2x")),
                   valueBox(h2(strong("121,897")), "Pruebas procesadas 2021 (moleculares, rápidas y antigénicas)", icon = icon("vial", "fa-2x")),
                   valueBox(h2(strong("822")), "Total Fallecidos 2021", icon = icon("skull-crossbones","fa-2x")))
                 ),
